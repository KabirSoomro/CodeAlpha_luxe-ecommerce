  ...
  return (
    <div className="admin-wrapper max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8 animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-luxe-glassBorder">
        <div>
          ...
          <p className="text-xs text-luxe-secondary mt-1">
            Real-time operations, inventory vaults, and customer fulfillment.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-4 py-1.5 rounded-xl glass border border-luxe-glassBorder hover:border-yellow-500/40 text-xs font-semibold text-luxe-primary hover:bg-white/5 transition-all"
          >
            ↻ Refresh
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="glass rounded-2xl p-6 border border-luxe-glassBorder relative overflow-hidden">
          ...
          <span className="text-[11px] text-luxe-secondary block mt-1">Active luxury catalog items</span>
        </div>
        ...
        <div className="glass rounded-2xl p-6 border border-luxe-glassBorder relative overflow-hidden">
          ...
          <span className="text-[11px] text-luxe-secondary block mt-1">≤ 3 items remaining</span>
        </div>
        ...
        <div className="glass rounded-2xl p-6 border border-luxe-glassBorder relative overflow-hidden">
          ...
          <span className="text-[11px] text-luxe-secondary block mt-1">Completed acquisitions</span>
        </div>
        ...
        <div className="glass rounded-2xl p-6 border border-luxe-glassBorder relative overflow-hidden">
          ...
          <span className="text-[11px] text-luxe-secondary block mt-1">Settled vault transactions</span>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between border-b border-luxe-glassBorder pb-4">
        ...
        {activeTab === 'products' && (
          <button
            ...
            className="px-4 py-2 rounded-xl bg-gradient-to-r from-amber-400 to-yellow-500 text-black text-xs font-bold shadow-md hover:scale-105 transition-all flex items-center gap-1.5"
          >
            <span>+</span>
                  ...
                  <tr key={prod._id} className="hover:bg-white/5 transition-colors">
                    <td className="p-4 flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-luxe-secondary">{prod.brand}</p>
                      </div>
                    </td>
                    ...
                    <td className="p-4 text-right space-x-2">
                      <button
                        ...
                        className="px-2.5 py-1 rounded-lg glass border border-luxe-glassBorder text-[11px] text-luxe-secondary hover:text-yellow-400 transition-colors"
                      >
                        Edit
                      </button>
                      <button
                        onClick={() => handleDeleteProduct(prod._id)}
                        className="px-2.5 py-1 rounded-lg border border-rose-500/30 text-[11px] text-rose-400 hover:bg-rose-500/10 transition-colors"
                      >
                        Retire
                      </button>
                    </td>
              ...
              <tbody id="orders-table-body" className="divide-y divide-luxe-glassBorder text-xs">
                {orders.map((ord) => (
                  <tr key={ord._id} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="p-4">
                      <p className="font-bold text-luxe-primary">{ord.user?.name || 'Client'}</p>
            ...
            <form id="create-product-form" onSubmit={handleSaveProduct} className="p-6 space-y-4">
              ...
              <div className="pt-3 flex justify-end gap-3">
                <button
                  type="button"
                  onClick={() => setShowProductModal(false)}
                  className="px-4 py-2 rounded-xl glass border border-luxe-glassBorder text-xs text-luxe-secondary hover:text-luxe-primary"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="px-6 py-2 rounded-xl bg-gradient-to-r from-amber-400 to-yellow-500 text-black text-xs font-bold shadow-md hover:scale-105 transition-all"
                >
